package com.baolian.dao.datasouce.aspect;

import com.alibaba.druid.util.StringUtils;
import com.baolian.dao.datasouce.HandleDataSource;
...
public class DataSourceAspect {
    ...
    /**
     * 切入点 service.impl包及子孙包下的所有类
     */
    @Pointcut("execution(* com.baolian.service.impl..*.*(..))")
    public void aspect() {
    }
    ...
    public DataSource getDataSource(Class<?> target, Method method) {
        try {
            ...
            e.printStackTrace();
            logger.error(String.format("通过注解切换数据源时发生异常[class=%s,method=%s]："
